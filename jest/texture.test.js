...
describe("texture", () => {
    it("interpolation texture", () => {
        ...
        const nt1 = t1.multiplyScalar(i1).add(t2.multiplyScalar(i2)).add(t3.multiplyScalar(i3))
        const nt2 = t1.multiplyScalar(o1).add(t2.multiplyScalar(o2)).add(t3.multiplyScalar(o3))
        const nt3 = t1.multiplyScalar(s1).add(t2.multiplyScalar(s2)).add(t3.multiplyScalar(s3))
        console.log(nt1,nt2,nt3)
    });
});
